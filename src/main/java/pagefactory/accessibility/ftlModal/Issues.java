...
package pagefactory.accessibility.ftlModal;
...
public class Issues {
	...
	public String toString() {
		return "Issues [browser=" + browser + ", date=" + date + ", device=" + device + ", dimension=" + dimension
				+ ", id=" + id + ", testEngine=" + testEngine + ", testEnvironment=" + testEnvironment + ", testRunner="
				+ testRunner + ", timestamp=" + timestamp + ", title=" + title + ", toolOptions=" + toolOptions
				+ ", url=" + url + ", violations=" + violations + ", inapplicable=" + inapplicable + ", incomplete="
				+ incomplete + ", additionalProperties=" + additionalProperties + "]";
	}
